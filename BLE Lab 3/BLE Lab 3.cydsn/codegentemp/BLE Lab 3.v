...
module BLE_v1_20_0 (
	...
	cy_clock_v1_0
		#(.id("0dd8817b-3f24-4b72-8d0b-2bcae82eb2b8/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module ADC_SAR_SEQ_P4_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("453af3c8-a8a3-435d-8a5f-807124619fd5/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("42e8a7d7-e3d1-41b1-9a5f-f33e648b49f1"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    assign Net_1440 = 1'h0;

	wire [0:0] tmpOE__BLE_Output_net;
	wire [0:0] tmpFB_0__BLE_Output_net;
	wire [0:0] tmpIO_0__BLE_Output_net;
	wire [0:0] tmpINTERRUPT_0__BLE_Output_net;
	electrical [0:0] tmpSIOVREF__BLE_Output_net;

	cy_psoc3_pins_v1_10
		#(.id("d4123a4e-dce5-48fb-b770-a14d6e0ff734"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BLE_Output
		 (.oe(tmpOE__BLE_Output_net),
		  .y({Net_2075}),
		  .fb({tmpFB_0__BLE_Output_net[0:0]}),
		  .io({tmpIO_0__BLE_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__BLE_Output_net),
		  .interrupt({tmpINTERRUPT_0__BLE_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLE_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
